...
int identificarFormato(char* letra) {
    if (strcmp(letra, "A") == 0 || strcmp(letra, "a") == 0 || strcmp(letra, "triangulo") == 0 || strcmp(letra, "Triangulo") == 0 || strcmp(letra, "triângulo") == 0 || strcmp(letra, "Triângulo") == 0) {
        return TRIANGULO;
    }
    else if (strcmp(letra, "B") == 0 || strcmp(letra, "b") == 0 || strcmp(letra, "quadrilatero") == 0 || strcmp(letra, "Quadrilatero") == 0 || strcmp(letra, "quadrilátero") == 0 || strcmp(letra, "Quadrilátero") == 0) {
        return QUADRILATERO;
    }
    else if (strcmp(letra, "C") == 0 || strcmp(letra, "c") == 0 || strcmp(letra, "pentagono") == 0 || strcmp(letra, "Pentagono") == 0 || strcmp(letra, "pentágono") == 0 || strcmp(letra, "Pentágono") == 0) {
        return PENTAGONO;
    }
    else if (strcmp(letra, "D") == 0 || strcmp(letra, "d") == 0 || strcmp(letra, "hexagono") == 0 || strcmp(letra, "Hexagono") == 0 || strcmp(letra, "hexágono") == 0 || strcmp(letra, "Hexágono") == 0) {
        return HEXAGONO;
    }
    else if (strcmp(letra, "E") == 0 || strcmp(letra, "e") == 0 || strcmp(letra, "circunferência") == 0 || strcmp(letra, "Circunferência") == 0 || strcmp(letra, "circuferencia") == 0 || strcmp(letra, "Circuferencia") == 0) {
...
int main(void) {
	...
	double modo, a, b, c, h, r, s, R, angulo;
	double area;
do{
	printf("\n   Escolha dentre as opções abaixo a figura geométrica para calcular a área:\n A)Triângulo\n B)Quadrilátero\n C)Pentágono\n D)Hexágono\n E)Circunferência\n   ");
	scanf("%s", &letra);
	...
	case TRIANGULO:	
		...
		else if(modo == 4)
		{
			...
			printf("\n Digite o lado de um triângulo equilátero: ");
			scanf("%lf", &a);
				area = (pow(a, 2) * sqrt(3)) / 4;
			printf("\n A área do triângulo é:%.5lf", area);	
		}
		else if(modo == 5)
		{
...
printf("\n   Quer continuar outra operação?\n   ");
scanf("%s", &again);
system("cls");
}while (strcasecmp(again, "sim") == 0 || strcasecmp(again, "Sim") == 0 || strcasecmp(again, "s") == 0 || strcasecmp(again, "S") == 0);

	printf("\n Agradeço por utilizar nossos serviços.\n");
	printf("\n ===============FINALIZADO=============== \n");
	return 0;
}
